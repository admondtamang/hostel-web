            ...
            {review.map((row, index) => (
              ...
              >
                <div class="relative flex-shrink-0 inline-flex items-center justify-center text-neutral-100 uppercase font-semibold shadow-inner rounded-full w-20 h-20 text-2xl ring-1 ring-white dark:ring-neutral-900">
                  <img class="absolute inset-0 w-full h-full object-cover rounded-full" src={row.Photo} alt="Truelock Alric" />
                ...
                <div class="mt-3">
                  ...
                  <span class="block mt-1.5 text-sm text-neutral-500 dark:text-neutral-400">{row.City}</span>
                </div>
