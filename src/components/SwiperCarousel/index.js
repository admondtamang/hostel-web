              ...
              {PlaceComponent ? (
                ...
                <>
                  <div className="w-full rounded-2xl flex-shrink-0 aspect-w-5 aspect-h-4 relative ">
                    <img src={row.image} class="object-cover w-full h-full rounded-2xl" alt="imgs" />
                  </div>
                  ...
                  <div class="mt-4 truncate">
                    <h2 class="text-base sm:text-lg text-neutral-900 dark:text-neutral-100 font-medium truncate">{row.name}</h2>
                    <span class="block mt-2 text-sm text-neutral-6000 dark:text-neutral-400">{row.caption}</span>
                  </div>
                </>
              )}
            </SwiperSlide>
